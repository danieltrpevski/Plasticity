...
NEURON {
	POINT_PROCESS adaptive_pf_NMDA
	RANGE g, Alpha, Beta, Erev, gmax, Cdur, iNMDA
	NONSPECIFIC_CURRENT  iNMDA
	RANGE mg, Cmax, eta, alpha, nmda_ca_fraction
        POINTER dopamine, stimulus_flag
	RANGE learning_rate_w_LTP, learning_rate_w_LTD, learning_rate_thresh_LTP, learning_rate_thresh_LTD, lthresh_LTP_min
	RANGE ca_nmdai_max, cali_max, active_syn_flag, Cdur_init, Cdur_factor, w0
