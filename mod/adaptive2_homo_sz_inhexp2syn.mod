...
NEURON {
	POINT_PROCESS adaptive2_homo_sz_inhexp2syn
	RANGE tau1, tau2, e, i, tau
	NONSPECIFIC_CURRENT i
	RANGE g, gmax
	RANGE delta_t, tlast
	RANGE weight, calcium_max, learning_rate, n, w0, active_syn_flag, last_wuf, silent_zone
...
BREAKPOINT {
	...
	if (weight_update_flag == 0) {
	  ...
	  s0 = sigmoidal(sf*calcium_max, theta - silent_zone, n)
