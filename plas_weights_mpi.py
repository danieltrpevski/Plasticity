...
if rank == 0:
    ...
    tasks = []
    e_weights = [0.06e-3, 0.065e-3, 0.07e-3, 0.075e-3, 0.08e-3, 0.085e-3,
                 0.09e-3, 0.095e-3, 0.1e-3, 0.105e-3, 0.11e-3, 0.115e-3, 0.12e-3,
                 0.125e-3, 0.13e-3, 0.135e-3, 0.14e-3, 0.145e-3, 0.15e-3,
                 0.155e-3, 0.16e-3, 0.165e-3, 0.17e-3, 0.175e-3, 0.18e-3, 0.185e-3,
                 0.19e-3]
    #i_weights = [0.75e-3, 1e-3, 1.25e-3, 1.5e-3, 1.75e-3, 2e-3, 2.5e-3]
    trials = 50
    for ew in e_weights:
        for trial in range(1, trials + 1):
            tasks.append([ew, trial])
...
for t in tasks:
    ew = t[0]; trial = t[1];
    print("Running trial %d for ew = %.4f." % (trial, ew))
    p.new_weight = ew

    ex = pe.Plasticity_Experiment('inhibitory_plasticity', cell)
...
if rank == 0:
    ...
    with open('./results/plas_weights.dat', 'w', encoding = 'utf-8') as f:
        json.dump(to_save, f)
