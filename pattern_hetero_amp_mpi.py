...
for t in tasks:
    ...
    ex = pe.Inhibitory_Experiment('pattern_hetero_amp', cell, dendstatobj = dendstatobj)
    ...
    synlist = ex.get_synapse_list('adaptive2_hetero_amp_inhexp2syn', clustered_flag = True, drive_type = 'i')
...
#                'tw': tw,
    ...
    with open('./results/pattern_hetero_amp_new.dat', 'w', encoding = 'utf-8') as f:
        json.dump(to_save, f)
